...
knitr::kable(Summary_Stats, caption = "Nr. observations in each group”)
```
...
So, per ANOVA, we have a statistically significant difference in Mean Tooth Growth between the 3 DOSES (p < 0.05 for the 3 doses).
